...
@CrossOrigin(origins = "*")
public class DonationAppointmentWebController {
    ...
    public DonationAppointmentWebController(DonationAppointmentService appointmentService,
    ...
    @ResponseBody
    public String test() {
        return "Web controller is working!";
    }
