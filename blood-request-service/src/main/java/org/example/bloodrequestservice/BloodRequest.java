...
public class BloodRequest {
    ...
    public BloodRequest(Long blood_request_id, String component_type, String blood_group, String rhesus_factor, String volume, LocalDateTime deadline, String comments, Long medcenter_id) {
    ...
    public Long getBlood_request_id() {
        return blood_request_id;
    }

    public void setBlood_request_id(Long blood_request_id) {
        this.blood_request_id = blood_request_id;
    }
    ...
    public Long getMedcenter_id(){
        return medcenter_id;
    }

    public void setMedcenter_id(Long medcenter_id){
        this.medcenter_id = medcenter_id;
    }
}
